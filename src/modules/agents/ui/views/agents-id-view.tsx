...
export const AgentIdView = ({ agentId }: Props) => {
    ...
    const [removeConfirmDialog, confirmRemove] = useConfirm("Confirm Removal", `The following action will remove the ${data.meetingCount} associated meetings`);
  ...
  return (
    <div className="py-54">
      <ErrorState
        ...
        description="There was an error loading the agent details."
      />
    </div>
  );
};
